...
function Search() {
    ...
    const fetchBooths = async (name: string) => {
        try {
            ...
            const response = await axios.get(`http://localhost:3000/booth/${booth}`); 
        ...
        <div className={style.body}>
            ...
            <div className={style.searchContainer}>
                <input 
                    ...
                    onKeyDown={(e) => {
                        if(e.key === 'Enter') {fetchBooths(inputText)}
                    }}
                />
                <img src='/images/searchIcon.png' className={style.searchIcon} onClick={() => fetchBooths(inputText)}/>
